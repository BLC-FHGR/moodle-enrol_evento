...
$string['enrolmodifytask'] = 'Course specific enrollment';
$string['enrolmodifytask_desc'] = 'Choose enrollment for specific course only';
$string['modifytask'] = 'Apply task to single course only';
